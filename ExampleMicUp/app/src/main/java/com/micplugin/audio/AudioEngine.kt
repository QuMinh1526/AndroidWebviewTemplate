...
class AudioEngine @Inject constructor(
    ...
    fun getInputSessionId(): Int = oboe.getInputSessionId()
    ...
    fun setInputDevice(deviceId: Int) = oboe.setInputDevice(deviceId)
    ...
    fun setGain(value: Float)         = oboe.setParam(5, 0, value)
    fun setGainEnabled(on: Boolean)   = oboe.setParam(5, 1, if (on) 1f else 0f)

    fun setEcho(value: Float)          = oboe.setParam(6, 0, value)
    fun setEchoEnabled(on: Boolean)    = oboe.setParam(6, 1, if (on) 1f else 0f)
