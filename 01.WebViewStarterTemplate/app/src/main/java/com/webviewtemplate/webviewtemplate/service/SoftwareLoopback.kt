...
object SoftwareLoopback {
    ...
    private const val TAG         = "WebViewTemplate.Loopback"
    ...
    fun start(context: Context) {
        ...
        monitorEnabled = context.getSharedPreferences("audio_preferences", Context.MODE_PRIVATE)
